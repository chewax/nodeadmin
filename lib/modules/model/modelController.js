(function () {
    ...
    var conn = require ("../../config/database").db;
    ...
    module.exports.schema = function(req, res){
        var schema = mongoose.models[req.params.name].schema;
    ...
    module.exports.retrieve = function(req, res) {
        ...
        var model = conn.model(req.params.name);
        var query = {}
    ...
    function renderModelManager(modelName, res) {
        var model = conn.model(modelName);
